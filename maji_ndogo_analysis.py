...
This module contains functions for analyzing agricultural data in Maji Ndogo.
"""
...
def load_and_clean_data(db_path='Maji_Ndogo_farm_survey_small.db'):
    """
    Load data from SQLite database and clean it.
    
    Args:
        db_path: Path to the SQLite database file
        
    Returns:
        pd.DataFrame: Cleaned DataFrame with agricultural data
    """
    ...
    # Check if columns are swapped (Crop_type vs Chosen_crop, Standard_yield vs Annual_yield)
    ...
    # 2. Fix spelling errors in crop types (convert to lowercase for consistency)
    ...
    # 3. Fix negative elevation values
...
if __name__ == "__main__":
    ...
    print("Maji Ndogo Analysis Module")
    print("Functions available:")
    print("- load_and_clean_data()")
    print("- explore_crop_distribution(df, crop_filter)")
    print("- analyse_soil_fertility(df)")
    print("- climate_geography_influence(df, column)")
    print("- find_ideal_fields(df)")
    print("- find_good_conditions(df, crop_type)")
